...
//    public static <T> Result<T> createBySuccess(Result <PageInfo> byPage) {
...
//    }
    ...
    public static <T> Result<T> createByMessage(String message) {
        return new Result<T>(ResponseCode.INVALID_USER.getCode(), message);
    }
